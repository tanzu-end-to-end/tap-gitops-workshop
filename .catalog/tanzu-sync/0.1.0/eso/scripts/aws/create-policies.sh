...
ASM_RESOURCE_ID_FOR_TANZU_SYNC=${ASM_RESOURCE_ID_FOR_TANZU_SYNC:-"dev/${EKS_CLUSTER_NAME}/tanzu-sync/*"}
ASM_RESOURCE_ID_FOR_TAP=${ASM_RESOURCE_ID_FOR_TAP:-"dev/${EKS_CLUSTER_NAME}/tap/*"}
